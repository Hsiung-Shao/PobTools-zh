...
inline constexpr LauncherStrings STR_ZHTW = {
	...
	u8"已偵測到",
	u8"未找到",
	u8"未找到 PathOfBuildingCommunity 資料夾",
	u8"未找到 PathOfBuildingCommunity-PoE2-Portable 資料夾",
...
inline constexpr LauncherStrings STR_EN = {
	...
	u8"Detected",
	u8"Not found",
	u8"PathOfBuildingCommunity folder not found",
	u8"PathOfBuildingCommunity-PoE2-Portable folder not found",
