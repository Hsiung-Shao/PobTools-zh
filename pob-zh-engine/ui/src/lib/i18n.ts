...
const EN: Record<string, string> = {
  ...
  "import.charTitle": "Import a character (pasted JSON)",
  "import.charHint": "Paste the raw responses of pathofexile.com's get-items and get-passive-skills for the character (from your browser's developer tools). Either box may be left empty.",
  "import.charItems": "get-items response",
  "import.charPassives": "get-passive-skills response",
  "import.optTree": "Import passive tree and jewels",
  "import.optDeleteJewels": "Delete existing jewels",
  "import.optItems": "Import items and skills",
  ...
  "import.charGo": "Import",
  "import.charDone": "Imported: {what}",
